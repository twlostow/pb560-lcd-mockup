...
/* Do not modify the enum order; due to trap record */
	SAVED_PATIENT_COUNTER_MIN_U16,//48
/* Do not modify the enum order; due to trap record */
...
/* Do not modify the enum order; due to trap record */
 	RETRIEVAL_EVENT_ADRESS_LSB_U16,// 52
/* Do not modify the enum order; due to trap record */
...
/* Do not modify the enum order; due to trap record */
	FLASH_TREND_WRITE_BLOCK_U16,// 56
/* Do not modify the enum order; due to trap record */
