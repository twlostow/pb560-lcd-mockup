...
/*%C V�rification : is the flash memory free									  */
	if (BUSY_MEM2 == 0)
		{ 
		return (3);
		}
/*%C v�rification : is the writting adress free		  */
	if ( *adr_prog != 0xFFFF)
		{
		return(4);
		}

/*%C 1st cycle programing s�quence 			  */
	adr_flash = (UWORD16 xhuge *)(EVENT_FLASH_START_ADDRESS + 0xAAA);
	*adr_flash = 0xAA;
	
/*%C 2d cycle programing s�quence		  */
	adr_flash = (UWORD16 xhuge *)(EVENT_FLASH_START_ADDRESS + 0x554);
	*adr_flash = 0x55;
	
/*%C 3d cycle programing s�quence			  */
	adr_flash = (UWORD16 xhuge *)(EVENT_FLASH_START_ADDRESS + 0xAAA);
	*adr_flash = 0xA0;
/*%C 4th cycle programing s�quence			  */
/*%C Loading of data to program */
	*adr_prog = data_prog; 
/*%C V�rification : is the flash acces free				  */
